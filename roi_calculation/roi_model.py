...
TODO: To learn how to solve (future) issue checkpoint of Nerfacto to be compatible with RoICalculation.
"""
...
@dataclass
class RoiModelConfig(ModelConfig):
    """Nerfacto Model Config"""

    _target: Type = field(default_factory=lambda: RoiModel)
